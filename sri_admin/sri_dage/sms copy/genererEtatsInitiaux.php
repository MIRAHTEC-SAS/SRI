<?php
  ...
  if (isset($_POST['EnvoyerAllEtatsInitiaux'])) {

    $codeFc=$_POST['codeFc'];

    // $codeDirection=$_GET['dir'];

    $getDirections = mysqli_query($con, "SELECT distinct codeDirection, codeFc FROM fc_initialisation_directions where codeFc='$codeFc'");
    ...
    $pdf->SetLineWidth(0.1); $pdf->Rect(110, 10, 90, 34, "D");
    ...
    // $typeDocument='Liste_eleves';
        ...
        $_SESSION['message'] ="Etats Initiaux sont generés et envoyés avec succès aux services ! ";
        header("Location: ../creer_fond_commun.php?fc=$codeFc");
