...
if ($action == 'getServices') {
    $sql = $con->query("SELECT DISTINCT localisation_services.code_service, services.libelle as nom_service FROM `localisation_services` INNER join services on services.code_service=localisation_services.code_service");
