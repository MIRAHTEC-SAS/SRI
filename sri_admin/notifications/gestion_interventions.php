...
if (isset($_POST['annulerIntervention'])) {
    ...
    if (!$sql) {
        ...
        $_SESSION['errorMsg'] = "Erreur lors de l'annulation de l'intervention. " . mysqli_error($con);
    ...
    $sql = mysqli_query($con, "UPDATE interventions set statut='annulee', date_saisie='$date_saisie' where code_intervention='$code_intervention'");
...
if (isset($_POST['validerIntervention'])) {
    ...
    if (!$sql) {
        $_SESSION['errorMsg'] = true;
        $_SESSION['successMsg'] = false;
        $_SESSION['message'] = "Erreur lors de la validation de l'incident " . mysqli_error($con);
        header("Location: ../interventions_planifiees");
        die();
    }
    ...
    // Update intervention
    $sql = mysqli_query($con, "UPDATE interventions SET statut='validee' WHERE code_intervention='$code_intervention' ");
    ...
    $_SESSION['errorMsg'] = false;
    $_SESSION['successMsg'] = true;
    $_SESSION['message'] = "Intervention validée avec succès !";
    header("Location: ../interventions_validees");
}
