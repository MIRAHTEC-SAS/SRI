									...
									<tr class="one-col">
										<td class="inner type" style="font-family:Arial,sans-serif;padding-top:30px;padding-bottom:30px;padding-right:30px;padding-left:30px;">
											<div class="mktEditable" id="main-content">
												...
												<p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;">Votre intervention prévue le '.$date_intervention.' provenant du service '.$service.' est annulée.</br></p>
												...
												<p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;">Description : <strong>'.$msg.'</strong></p>
