									...
									<tr class="one-col">
										<td class="inner type" style="font-family:Arial,sans-serif;padding-top:30px;padding-bottom:30px;padding-right:30px;padding-left:30px;">
											<div class="mktEditable" id="main-content">
												...
												<p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;">Vous avez affecté une demande d\'intervention  "' . $description . '", de type ' . $type_incident . '   effectuée le ' . formatDateTime($date_declaration) . ' par la  ' . $service . '/' . $etage . '/' . $piece . '   le  ' . formatDateTime($date_saisie) . '  à ' . $concerne . '</p>
