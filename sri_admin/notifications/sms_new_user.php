			...
			<center>
				<div class="webkit" style="margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;width:94%;max-width:600px;">
					...
					<tr class="hide"><td style="font-size:20px;line-height:20px;">&nbsp;</td></tr>
                        ...
                        <p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;text-align:center"><button style="background-color:#146132"><a style="color:white"href="http://localhost/sri/sri_admin/dashnord">Acceder a la plateforme</a></button></p>
