...
!(function (i) {
  ...
  function o(o) {
    return this.each(function () {
      ...
      if (
        (n ||
          ((t = i.extend({}, r, e.data(), "object" == typeof o && o)),
          e.data(a, (n = new s(t)))),
        "string" == typeof o)
      ) {
  ...
  (s.prototype.activate = function () {
    this.fix(),
      ...
      this.options.resetHeight &&
        i("body, html, " + l).css({ height: "auto", "min-height": "100%" }),
      this.bindedResize ||
        (i(window).resize(
          function () {
            this.fix(),
    ...
    (s.prototype.fix = function () {
      ...
      var t = i(u).outerHeight() || 0,
        ...
        o = i(p).height() || 0;
      i("body").hasClass(m)
        ? i(c).css("min-height", n - t)
        : ((e =
            o <= n
              ? (i(c).css("min-height", n - e), n - e)
              : (i(c).css("min-height", o), o)),
          void 0 !== (o = i(f)) &&
            o.height() > e &&
            i(c).css("min-height", o.height()));
    }),
    (s.prototype.fixSidebar = function () {
      i("body").hasClass(m)
        ? this.options.slimscroll &&
          void 0 !== i.fn.slimScroll &&
          (i(p).slimScroll({ destroy: !0 }).height("auto"),
          i(p).slimScroll({
  ...
  var g = i.fn.layout;
  (i.fn.layout = o),
    (i.fn.layout.Constuctor = s),
    (i.fn.layout.noConflict = function () {
    ...
    (s.prototype.init = function () {
      ...
      (s.prototype.toggle = function () {
        var t = i(window).width(),
          e = !i("body").hasClass(u);
        t <= this.options.collapseScreenSize && (e = i("body").hasClass(h)),
          e ? this.close() : this.open();
      }),
      (s.prototype.open = function () {
        (i(window).width() > this.options.collapseScreenSize
          ? i("body").removeClass(u)
          : i("body").addClass(h)
        ).trigger(i.Event(f));
      }),
  ...
  (function (s) {
    ...
    function o(t, e) {
      (this.element = t),
        (this.options = e),
        s(this.element).addClass(u),
        s(r + n, this.element).addClass(d),
    ...
    function e(n) {
      return this.each(function () {
        var t,
          e = s(this);
        e.data(i) ||
          ((t = s.extend({}, a, e.data(), "object" == typeof n && n)),
          e.data(i, new o(e, t)));
      });
    }
    (o.prototype.toggle = function (t, e) {
      ...
      o.is(r) &&
        ((this.options.followLink && "#" != t.attr("href")) ||
          e.preventDefault(),
        i ? this.collapse(n, o) : this.expand(n, o));
    }),
      (o.prototype.expand = function (t, e) {
        ...
        this.options.accordion &&
          ((o = (n = e.siblings(c)).children(l)), this.collapse(o, n)),
          e.addClass(d),
          t.slideDown(
  ...
  (function (i) {
    ...
    function p(o) {
      return this.each(function () {
        ...
        n ||
          ((t = i.extend({}, r, e.data(), "object" == typeof o && o)),
          e.data(a, (n = new s(e, t)))),
          "string" == typeof o && n.toggle();
      });
    }
    (s.prototype.init = function () {
      ...
      (s.prototype.expand = function () {
        (this.options.slide ? i(e) : i("body")).addClass(d),
          i(this.element).trigger(i.Event(h));
      }),
      (s.prototype.collapse = function () {
      ...
      (s.prototype._fixForBoxed = function (t) {
        t.css({ position: "absolute", height: i(l).height() });
      });
    var f = i.fn.controlSidebar;
    (i.fn.controlSidebar = p),
  ...
  (function (i) {
    ...
    var a = "Masteradmin.todolist",
      r = { iCheck: !1, onCheck: function () {}, onUnCheck: function () {} },
  ...
  (function (i) {
    ...
    (i.fn.directChat = a),
      (i.fn.directChat.Constructor = o),
      (i.fn.directChat.noConflict = function () {
        return (i.fn.directChat = r), this;
      }),
      i(document).on("click", t, function (t) {
        t && t.preventDefault(), a.call(i(this), "toggle");
      }),
      i(".inner-content-div").slimScroll({ height: "200" }),
      i(".sm-scrol").slimScroll({ height: "250" }),
      i(".direct-chat-messages").slimScroll({ height: "420" }),
      i(".chat-box-one").slimScroll({ height: "550" }),
      i(".chat-box-one2").slimScroll({ height: "580" }),
      i(".chat-box-one-side").slimScroll({ height: "650" }),
      i(".chat-box-one-side2").slimScroll({ height: "500" }),
      i(".chat-box-one-side3").slimScroll({ height: "685" }),
      i(".notification-side").slimScroll({ height: "325" }),
      i(".suggestions-side").slimScroll({ height: "300" }),
      i(".events-side").slimScroll({ height: "265" }),
      i(".pat-div").slimScroll({ height: "204" }),
      i(".demo-panel-bx").slimScroll({ height: "auto" }),
      i(".search-box a, .search-box .app-search .srh-btn").on(
        "click",
        function () {
      ...
      i(document).on("click", ".box-btn-close", function () {
        i(this)
          ...
          .fadeOut(600, function () {
            (1 == i(this).parent().children().length
              ? i(this).parent()
              : i(this)
            ).remove();
          });
      ...
      i(".open-left-block").on("click", function () {
        i(".left-block").toggleClass("open-panel"),
          i(".open-left-block").toggleClass("mdi-menu");
      }),
      i(document).on("click", ".file-browser", function () {
        ...
        e.hasClass("form-control")
          ...
          : ((t = e.closest(".file-group").find('[type="file"]')).on(
              "click",
              function (t) {
                t.stopPropagation();
              }
      ...
      i(document).on("change", '.file-group [type="file"]', function () {
        for (var t = i(this)[0], e = t.files.length, n = "", o = 0; o < e; ++o)
          n += t.files.item(o).name + ", ";
      ...
      i(".custom-file-control:not([data-input-value])").attr(
        "data-input-value",
        "Choose file..."
      ),
      i(".todo-list").todoList({
        onCheck: function () {
    ...
    var l = {
        ...
        show: function (t, e) {
          ...
          var i,
            ...
            s =
              ((s = { top: 0, left: 0 }),
              (e = (i = (a = n) && a.ownerDocument).documentElement),
              void 0 !== a.getBoundingClientRect &&
                (s = a.getBoundingClientRect()),
              (a =
                null !== (i = a = i) && i === i.window
                  ? a
          ...
          "touches" in t &&
            ...
            (e = t.touches[0].pageX - s.left)),
            o.setAttribute("data-hold", Date.now()),
            o.setAttribute("data-scale", n),
            o.setAttribute("data-x", e),
            o.setAttribute("data-y", a);
          e = { top: a + "px", left: e + "px" };
          (o.className = o.className + " waves-notransition"),
            o.setAttribute("style", r(e)),
            ...
            (e["-moz-transition-timing-function"] =
              "cubic-bezier(0.250, 0.460, 0.450, 0.940)"),
        ...
        wrapInput: function (t) {
          for (var e = 0; e < t.length; e++) {
            ...
            "input" === s.tagName.toLowerCase() &&
              (("i" === (n = s.parentNode).tagName.toLowerCase() &&
                -1 !== n.className.indexOf("waves-effect")) ||
                (((o = document.createElement("i")).className =
                  s.className + " waves-input-wrapper"),
                (i = (i = s.getAttribute("style")) || ""),
    ...
    (t.displayEffect = function (t) {
      ...
      (t.attach = function (t) {
        "input" === t.tagName.toLowerCase() &&
          (l.wrapInput([t]), (t = t.parentNode)),
          "ontouchstart" in n && t.addEventListener("touchstart", o, !1),
