...
if (isset($_SESSION['User']) && isset($_SESSION['UserPass']) && $_SESSION['role'] == 'Administrateur' || $_SESSION['role'] == 'Responsable') {
	...
	$getInfosResponsables = mysqli_query($con, "SELECT * FROM `responsables_dage` order by id desc");
...
?>
	...
	if (isset($_GET['edit'])) {
		...
		$matricule_responsable = $_GET['edit'];

		$getInfosResponsable = mysqli_query($con, "SELECT * FROM responsables_dage where matricule='$matricule_responsable'");
	...
	if (isset($_GET['delete'])) {
		...
		$matricule_responsable = $_GET['delete'];
				...
				<div class="container-full">
					...
					<div class="content-header">
						<div class="d-flex align-items-center">
							...
							<div class="text-end">
								<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-success mt-10 d-block text-center"><i class="fa fa-plus-circle"></i> Nouveau Responsable</a>
							</div>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header" style="background-color:#DFDFDE">
											<h4 class="modal-title" id="myModalLabel">Ajout d'un nouveau responsable</h4>
										...
										<div class="modal-body" style="background-color:#F7F5F2">
											<form action="controllers/referentielController.php" method="POST">
												...
												<div class="modal-footer">
													<button type="submit" name="ajouterResponsable" class="btn btn-success">Ajouter</button>
											...
											<form action="controllers/referentielController.php" method="POST">
												<div class="row">
													...
													<div class="col-3">
														...
														<input type="hidden" name="matricule_responsable" value="<?php echo $matricule_responsable; ?>">
													</div>
												</div>
												</br>
												...
												<div class="row">
													<div class="container-fluid">
														...
														<?php if ($update == 1) { ?> <button type="submit" name="modifierResponsable" class="btn btn-warning form-control" style="color:black;height:90%"><i class="fa fa-edit"></i> Modifier</button><?php } ?>
														<?php if ($update == 2) { ?> <button type="submit" name="supprimerResponsable" class="btn btn-danger form-control" style="color:white;height:90%"><i class="fa fa-trash"></i> Supprimer</button><?php } ?>
													</div>
												</div>
										</div>
										</form>
					...
					<div class="col-12">
						<div class="box">
							<div class="box-header with-border">
								<h4 class="box-title">Liste des responsables des domaines d'interventions</h4>
							</div>

							<div class="box-body" style="background-color:#FBFBFB">
								<?php include('contents/content-responsables-dage.php'); ?>
							</div>
							<!-- /.box-body -->
