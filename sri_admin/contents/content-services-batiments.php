			...
			<?php if (!empty($getServiceBatiments)) while ($row = mysqli_fetch_array($getServiceBatiments)) {  ?>
				<tr>
					...
					<td style="text-align:center">
						<a href="services_batiments?edit=<?php echo $row['id']; ?>" class="text-info me-10" data-bs-toggle="tooltip" data-bs-original-title="Edit">
							<i class="fa fa-edit" style="font-size:16px;color:orange"></i>
						</a>
						<a href="services_batiments?delete=<?php echo $row['id']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
