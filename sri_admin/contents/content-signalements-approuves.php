...
$getSignalements = mysqli_query($con, "SELECT * FROM `signalements` INNER JOIN services on services.code_service=signalements.code_service where statut='Approuvée par le responsable'");
