			...
			<?php if (!empty($getBatiments)) while ($row = mysqli_fetch_array($getBatiments)) {  ?>
				<tr>
					...
					<td style="text-align:center">
						<a href="batiments.php?edit=<?php echo $row['code_batiment']; ?>" class="text-info me-10" data-bs-toggle="tooltip" data-bs-original-title="Edit">
							<i class="fa fa-edit" style="font-size:16px;color:orange"></i>
						</a>
						<a href="batiments.php?delete=<?php echo $row['code_batiment']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
