			...
			<?php if (!empty($getEtages)) while ($row = mysqli_fetch_array($getEtages)) {  ?>
				<tr>
					...
					<td style="text-align:center">
						<a href="etages?edit=<?php echo $row['code_etage']; ?>" class="text-info me-10" data-bs-toggle="tooltip" data-bs-original-title="Edit">
							<i class="fa fa-edit" style="font-size:16px;color:orange"></i>
						</a>
						<a href="etages?delete=<?php echo $row['code_etage']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
