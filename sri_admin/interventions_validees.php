  ...
  $t_i_5=$liste_codes_incident_resp[4];
	...
	switch ($profil) 
	{
		...
		case 'Intervenant' :
			...
			WHERE interventions.statut='validee' AND intervenants_interne.matricule_intervenant='$matricule'");
		break;	
	}
?>
<?php 
					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">a clôturer</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<div class="col-12">
					<div class="box">
						<div class="box-header with-border">
						  <?php if ($roleUser=='Responsable') { ?> <h4 class="box-title">Liste des interventions à cloturer</h4><?php } else { ?>
						  <h4 class="box-title">Liste des interventions validées</h4>
						  <?php } ?>
						...
						<div class="box-body" style="background-color:#FBFBFB">
							...
							{
								include('contents/content-interventions_validee_intervenant.php'); 
							}
							else
							{
								include('contents/content-interventions_validees.php'); 
							}
							?>
						</div>
						<!-- /.box-body -->
...
<?php } else {header('Location: ../sri_dage');}  ?>