											...
											<div class="row">
												...
												<div class="col-3">
													...
													<?php if ($update == 1) { ?>
														...
														<button type="submit" name="modifierPrestataire" class="btn btn-warning form-control" style="color:black;height:50%"><i class="fa fa-edit"></i> Modifier affectation</button>
													<?php } ?>
													<?php if ($update == 2) { ?>
														<input type="hidden" name="id_affectation" value="<?php echo $id_affectation; ?>">
