					...
					<div class="col-lg-5 col-md-5 col-12">						
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								<h3 class="mb-0 text-primary">Récuperer votre mot de passe</h3>								
							</div>
							<div class="p-40">
								<form action="controllers/referentielController.php" method="post">
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="email" name="email" class="form-control ps-15 bg-transparent" placeholder="Saisir votre email">
										</div>
									</div>
									  <div class="row">
										<div class="col-12 text-center">
										  <button type="submit" name="reinitialiserPassword" class="btn btn-info margin-top-10">Reinitialiser</button>
										</div>
										<!-- /.col -->
									  </div>
								</form>	
