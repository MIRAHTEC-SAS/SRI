											...
											<form action="controllers/referentielController.php" method="POST">
												<div class="form-group">
													...
													<div class="input-group mb-3">
														...
														<input type="text" name="adresse" class="form-control" placeholder="Representant">
													</div>
													<!-- <label class="form-label">Telephone</label> -->
													<div class="input-group mb-3">
														<span class="input-group-text"><i class="ti-mobile"></i></span>
														<input type="text" minlength="9" maxlength="9" name="telephone" class="form-control" placeholder="Telephone" required>
													</div>
