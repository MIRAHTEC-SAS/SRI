											...
											<div class="modal-body" style="background-color:#F7F5F2">
												<form action="controllers/referentielController.php" method="POST">
													<div class="form-group">
														...
														<div class="col-md-12">
															<select name="code_batiment" class="form-control" v-model="newEtage.code_batiment">
														...
														<div class="col-md-12">
															<input type="text" name="nom_etage" v-model="newEtage.nom_etage" class="form-control" placeholder="Nom de l'etage">
													...
													<div class="modal-footer">
														<button type="submit" name="ajouterEtage" class="btn btn-success">Ajouter</button>
						...
						<div class="row">
												...
												<div class="row">
													...
													<div class="col-2">
														<?php if ($update == 1) { ?>
															...
															<button type="submit" name="modifierEtage" class="btn btn-warning form-control" style="color:black;height:90%"><i class="fa fa-edit"></i> Modifier</button><?php } ?>
														<?php if ($update == 2) { ?>
															<input type="hidden" name="code_etage" value="<?php echo $code_etage; ?>">
															<button type="submit" name="supprimerEtage" class="btn btn-danger form-control" style="color:white;height:90%"><i class="fa fa-trash"></i> Supprimer</button><?php } ?>
													</div>
												</div>
											</form>
										</div>
							...
							<div class="col-12">
								<div class="box">
									...
									<div class="box-body">
										<?php include('contents/content-etages.php'); ?>
									</div>
									<!-- /.box-body -->
