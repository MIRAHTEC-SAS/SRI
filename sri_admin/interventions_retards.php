...
if (isset($_SESSION['User']) && isset($_SESSION['UserPass']) && $_SESSION['role'] == 'Administrateur' || $_SESSION['role'] == 'Responsable'  || $_SESSION['role'] == 'Gestionnaire' || $_SESSION['role'] == 'Intervenant') {
	...
	switch ($profil) {
		case 'Administrateur':
			...
			WHERE interventions.statut='en retard'");
			break;
		case 'Responsable':
			...
			INNER JOIN services ON services.code_service=interventions.service
			INNER JOIN type_incidents ON type_incidents.code_incident=interventions.code_incident 
			WHERE interventions.statut='en retard' AND interventions.code_incident IN ('$t_i_1','$t_i_2','$t_i_3','$t_i_4','$t_i_5')");
			break;
		case 'Gestionnaire':
			$getInterventionsRetard = mysqli_query($con, "SELECT 
			interventions.code_intervention,
								...
								<div class="d-inline-block align-items-center">
									<nav>
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">En retards</li>
										</ol>
									</nav>
								</div>
							</div>
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header with-border">
										<h4 class="box-title">Liste des interventions en retard</h4>
									</div>
									<div class="box-body" style="background-color:#FBFBFB">
										<?php include('contents/content-interventions_retards.php'); ?>
									</div>
									<!-- /.box-body -->
