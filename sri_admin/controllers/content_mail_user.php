									...
									<tr class="one-col">
										<td class="inner type" style="font-family:Arial,sans-serif;padding-top:30px;padding-bottom:30px;padding-right:30px;padding-left:30px;">
											<div class="mktEditable" id="main-content">
												<p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;">Bonjour, ' . $prenomNomUser . ' </p>
	
												<p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;">Un compte d\'accès à l\'application SRI (système de remontée des incidents) de la DAGE vous a été créé avec les paramètres suivants : </br></p>
												<p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;">Login: <strong>' . $emailUser . '</strong></p>
												<p style="margin-top:0;margin-right:0;margin-left:0;margin-bottom:8px;"> Mot de passe : <strong">dtai@2023</strong></p>
												
                        <div style="text-align:center;">
   												 <a style="color:white; font-size:18px; text-decoration:none; background-color:#446A46; padding:10px; display:inline-block;" href="http://localhost/sri/sri_admin/">
        											Se connecter
    												</a>
												</div>
