										...
										<form action="services/parametrages.php" method="POST">
											<div class="row">
												...
												<div class="col-12">
													...
													<?php if ($update == 1) { ?> <button type="submit" name="modifierServiceBatiments" class="btn btn-warning form-control" style="color:black;height:50%"><i class="fa fa-edit"></i> Modifier affectation</button><?php } ?>
													<?php if ($update == 2) { ?> <button type="submit" name="supprimerServiceBatiments" class="btn btn-danger form-control" style="color:white;height:50%"><i class="fa fa-trash"></i> Supprimer</button><?php } ?>
												</div>
											</div>
										</form>
									</div>
