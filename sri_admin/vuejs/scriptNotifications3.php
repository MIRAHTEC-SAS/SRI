...
<script>
    const vue = new Vue({
        data: {
            ...
            urlGetSallesInit: "API/api_cfj.php?action=getSallesInitSessions",
        ...
        computed: {
            ...
            selectedSessionGroupes() {
                return this.groupesSession.filter(groupe => groupe.codeSession === this.newPlanif.codeSession && groupe.codeSession === this.newPlanif.codeSession && groupe.codeCentre === this.newPlanif.codeCentre && groupe.codeSalle === this.newPlanif.codeSalle);
            },
            selectedConcours() {
