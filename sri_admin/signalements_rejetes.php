...
if (isset($_SESSION['User']) && isset($_SESSION['UserPass']) && $_SESSION['role'] == 'Administrateur' || $_SESSION['role'] == 'Responsable' || $_SESSION['role'] == 'Gestionnaire') {
	...
	switch ($profil) {
		...
		case 'Gestionnaire':
			...
			where signalements.statut='rejete' AND services.code_service='$code_service'");
			break;
	}
								...
								<div class="d-inline-block align-items-center">
									<nav>
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Rejetés</li>
										</ol>
									</nav>
								</div>
							</div>
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header with-border">
										<h4 class="box-title">Liste des incidents rejetés</h4>
									</div>
									<div class="box-body" style="background-color:#FBFBFB">
										<?php include('contents/content-signalements-rejetes.php'); ?>
									</div>
									<!-- /.box-body -->
