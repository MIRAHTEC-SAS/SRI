...
if (isset($_POST['validerServicesBatiments'])) {
    ...
    header("Location: ../services_batiments");
}
...
if (isset($_POST['validerServicesBatimentsEtages'])) {
    ...
    header("Location: ../services_etages");
}

// Modification 
if (isset($_POST['modifierServiceBatimentsEtages'])) {
    $code_service = $_POST['code_service'];
    $code_batiment = $_POST['code_batiment'];
    $code_etage = $_POST['code_etage'][0];
    $id_affectation = $_POST['id_affectation'];
    ...
    // UPDATE
    $sql = mysqli_query($con, "UPDATE `localisation_services_etage` SET code_service='$code_service', code_batiment='$code_batiment', code_etage='$code_etage' WHERE id='$id_affectation'");
    if ($sql) {
        // $query = $con->query("SELECT * FROM `localisation_services_etage` WHERE id = '$id_affectation'");
        ...
        $_SESSION['message'] = "Erreur lors de la modification de l'affectation!" . mysqli_error($con);
        header("Location: ../services_etages");
    }
}
// SUPPRIMER
if (isset($_POST['supprimerServiceBatimentsEtages'])) {
    ...
    // DELETE
    mysqli_query($con, "DELETE FROM `localisation_services_etage` WHERE id='$id_affectation'");
