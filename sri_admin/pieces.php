				...
				<div class="container-full">
					...
					<div class="content-header">
						<div class="d-flex align-items-center">
							...
							<div id="app">
								<div class="text-end">
									<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-success mt-10 d-block text-center"><i class="fa fa-plus-circle"></i> Nouvelle Piéce</a>
								</div>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header" style="background-color:#DFDFDE">
												<h4 class="modal-title" id="myModalLabel">Ajouter une nouvelle Piéce</h4>
														...
														<div class="col-3">
															<select name="code_etage" class="form-control" disabled>
																...
																<?php while ($row = mysqli_fetch_array($getEtages)) {
																	$codeEtage = $row['code_etage'];
																	if ($code_etage != $codeEtage) { ?>
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header with-border">
										<h4 class="box-title">Liste des pièces</h4>
									</div>
