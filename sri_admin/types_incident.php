								...
								<div class="d-inline-block align-items-center">
									<nav>
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Domaine d'intervention</li>
										</ol>
									</nav>
								</div>
							</div>
							<div class="text-end">
								<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-success mt-10 d-block text-center"><i class="fa fa-plus-circle"></i> Ajouter un domaine d'intervention</a>
							</div>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header" style="background-color:#DFDFDE">
											<h4 class="modal-title" id="myModalLabel">Ajout d'un Domaine d'intervention</h4>
											...
											<form action="controllers/referentielController.php" method="POST">
												<div class="form-group">
													...
													<div class="input-group mb-3">
														...
														<label class="col-form-label col-md-4">Domaine d'intervention :</label>
														<div class="col-md-8">
															<input type="text" name="type_incident" class="form-control" placeholder="Domaine d'intervention">
														</div>
													</div>
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header with-border">
										<h4 class="box-title">Liste des domaines d'intervention</h4>
									</div>
