...
<head>
    ...
    <title>DAGE | Signaler un incident </title>
			...
			<div class="col-lg-6 content-left">
				<div class="content-left-wrapper">
					...
					<div>
						...
						<h2 style="color:black;text-align:center">Bienvenue sur la plateforme de signalement des incidents de la DAGE du ministeres des finances et du budget </h2>
						<p style="color:#413F42; text-align:justify;font-size:16px;">Un disfonctionnement dans vos locaux ou un evenement inattendu ?</br> Vous êtes au bon endroit pour remonter l'incident.</br></br>Merci de prendre une à 3 photos et remplir le formulaire ci-dessous pour remonter l'incident en quelques clics. </p>
						<!-- <a href="#0" class="btn_1 rounded">Purchase this template</a> -->
						<!-- <a href="#start" class="btn_1 rounded mobile_btn">Start Now!</a> -->
					</div>
					<div class="copy">© 2022 Ministere des finances et du budget - DTAI - DAGE</div>
				</div>
