...
if (isset($_POST['ouvrirFc'])) {
    ...
    agents.matricule,
    agents.codeDirection,
    agents.prenom,
    agents.nom,
    agents.hierarchie,
    statut_agents.statut,
    statut_agents.commentaire,
    directions.libelle as libelleDirection
    FROM agents INNER JOIN statut_agents ON agents.matricule=statut_agents.matricule INNER JOIN directions ON directions.codeDirection=agents.codeDirection WHERE agents.codeMinistere='$codeMinistere'");
...
if (isset($_POST['enleverAgent'])) {
    ...
    header("Location: ../initialiser_fond_commun.php?fc=$codeFc&dir=$direction");
  ...
  if (isset($_POST['enleverAgentDir'])) {
    ...
    $_SESSION['successMsg']=true;
    $_SESSION['message'] ="Agent enlevé de la liste avec succès ! ";
    header("Location: ../maj_fond_commun.php?fc=$codeFc&dir=$direction");
...
if (isset($_POST['annulerInitDir'])) {
  ...
  while ($row = mysqli_fetch_array($infosInit)) { 
      ...
      $_SESSION['successMsg']=true;
      $_SESSION['message'] ="Saisie annulée avec succès ! ";
      header("Location: ../maj_fond_commun.php?fc=$codeFc&dir=$codeDirection");
...
// INSERT INTO `fc_en_cours_notation` (`id`, `codeFc`, `codeDirection`, `codeMinistere`, `matricule`, `hierarchie`, `nb_part`, `decade`, `note`, `points`, `date_saisie`)
      ...
      VALUES ('$codeFc','$codeMinistere','$codeDirection','$matricule','$hierarchie','$nb_part','0','0','0','$dateDuJour')");
  ...
  // Stats nb agent
      ...
      header("Location: ../maj_fond_commun.php?fc=$codeFc");
...
VALUES ('$codeFc','$codeDirection','$codeMinistere','$nbAgent','$pointsDirection','$commentaire','$dateDuJour')");
    ...
    //   $sql = $con->query("DELETE FROM fc_notes_validees where codeFc='$codeFc'");
        ...
        header("Location: ../monitoring_notes.php?fc=$codeFc");
...
if (isset($_POST['envoyerEtatsTresor'])) {
    ...
    //   VALUES ('$codeFc','$codeDirection','$codeMinistere','$matricule','$hierarchie','$nb_part',' $decade','$note','$points','$montant','$dateDuJour')");
      ...
      $sql = $con->query("DELETE FROM fc_notes_signees where codeFc='$codeFc' AND codeDirection='$codeDirection'");
        ...
        header("Location: ../monitoring_notes_signees.php?fc=$codeFc");
    //   $sql = $con->query("DELETE FROM fc_notes_validees where codeFc='$codeFc'");
...
if (isset($_POST['envoyerEtatsSgTresor'])) {
    ...
    //   VALUES ('$codeFc','$codeDirection','$codeMinistere','$matricule','$hierarchie','$nb_part',' $decade','$note','$points','$montant','$dateDuJour')");
      ...
      $sql = $con->query("DELETE FROM fc_notes_signees_tresor where codeFc='$codeFc' and codeDirection='$codeDirection'");
        ...
        header("Location: ../monitoring_tresor.php?fc=$codeFc");
