			...
			<div class="row">
				...
				<aside class="col-lg-4" v-bind="resume" v-if="newSignalement.code_incident">
					...
					<div class="box_style_2" style="background-color:#E7E7E9">
						...
						<div class="row text-center">
								<div class="col-md-12" v-if="newSignalement.code_incident && newSignalement.code_localisation && newSignalement.description && newSignalement.auteur && newSignalement.telephone">		
									</br>
